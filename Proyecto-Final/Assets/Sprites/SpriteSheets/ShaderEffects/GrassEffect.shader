...
Shader "GrassEffect"
{
	Properties
	{
		...
		[ASEEnd]_PixelSize("PixelSize", Float) = 16
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float4 tex2DNode8 = tex2D( _Texture0, uv_Texture0 );
				float4 color11 = IsGammaSpace() ? float4(1,0,0,0) : float4(1,0,0,0);
				float temp_output_10_0 = saturate( ( 1.0 - ( ( distance( color11.rgb , tex2DNode8.rgb ) - 0.0 ) / max( 0.0 , 1E-05 ) ) ) );
				float time46 = 0.0;
				float temp_output_25_0 = ( 1.0 / _PixelSize );
				float simplePerlin2D30 = snoise( ( floor( ( WorldPosition / temp_output_25_0 ) ) * temp_output_25_0 ).xy );
				float2 temp_cast_3 = (( simplePerlin2D30 * ( IN.ase_texcoord8.xyz.y + 0.0 ) )).xx;
				float2 coords46 = temp_cast_3 * 1.0;
				float2 id46 = 0;
				float2 uv46 = 0;
				float voroi46 = voronoi46( coords46, time46, id46, uv46, 0 );
				float temp_output_40_0 = floor( voroi46 );
				float4 color34 = IsGammaSpace() ? float4(0.2515281,0.546,0.3956967,1) : float4(0.05149,0.2591152,0.1298723,1);
				float4 color37 = IsGammaSpace() ? float4(0.427451,0.7843138,0.6039216,1) : float4(0.1529262,0.5775806,0.3231432,1);
				
				float3 Albedo = ( ( tex2DNode8 - ( temp_output_10_0 * color11 ) ) + ( temp_output_10_0 * ( ( temp_output_40_0 * color34 ) + ( ( 1.0 - temp_output_40_0 ) * color37 ) ) ) ).rgb;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float temp_output_25_0 = ( 1.0 / _PixelSize );
				float simplePerlin2D30 = snoise( ( floor( ( WorldPosition / temp_output_25_0 ) ) * temp_output_25_0 ).xy );
				float2 temp_cast_3 = (( simplePerlin2D30 * ( IN.ase_texcoord3.xyz.y + 0.0 ) )).xx;
				float2 coords46 = temp_cast_3 * 1.0;
				float2 id46 = 0;
				float2 uv46 = 0;
				float voroi46 = voronoi46( coords46, time46, id46, uv46, 0 );
...
/*ASEBEGIN
Version=18900
-48.6445;692.7636;1498;399;1504.72;-369.4197;1.389843;True;False
Node;AmplifyShaderEditor.RangedFloatNode;24;-1957.321,676.173;Inherit;False;Constant;_PixelDivision;PixelDivision;4;0;Create;True;0;0;0;False;0;False;1;0.4;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;23;-1941.321,756.173;Inherit;False;Property;_PixelSize;PixelSize;1;0;Create;True;0;0;0;False;0;False;16;16;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.WorldPosInputsNode;26;-1765.321,532.1729;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.SimpleDivideOpNode;25;-1801.705,675.1169;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleDivideOpNode;27;-1603.958,529.9988;Inherit;True;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.FloorOpNode;28;-1411.958,529.9988;Inherit;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.PosVertexDataNode;47;-1497.411,729.0236;Inherit;True;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;29;-1253.321,532.1729;Inherit;True;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.NoiseGeneratorNode;30;-818.3555,478.9664;Inherit;True;Simplex2D;False;False;2;0;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;44;-767.6456,714.4942;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;45;-585.2823,734.2527;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.VoronoiNode;46;-357.64,676.9655;Inherit;True;0;0;1;0;1;False;1;False;False;4;0;FLOAT2;0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0;False;3;FLOAT;0;FLOAT2;1;FLOAT2;2
Node;AmplifyShaderEditor.TexturePropertyNode;9;-1216,96;Inherit;True;Property;_Texture0;Texture 0;0;0;Create;True;0;0;0;False;0;False;d8844b45c8e11f54cb8ca68d1e7db6e9;d8844b45c8e11f54cb8ca68d1e7db6e9;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.FloorOpNode;40;-429.3981,444.7151;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;37;-220.2525,739.2207;Inherit;False;Constant;_Color2;Color 2;2;0;Create;True;0;0;0;False;0;False;0.427451,0.7843138,0.6039216,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.OneMinusNode;35;94.60946,681.0189;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;11;-977.2861,295.832;Inherit;False;Constant;_Color0;Color 0;1;0;Create;True;0;0;0;False;0;False;1,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;8;-995,81;Inherit;True;Property;_TextureSample0;Texture Sample 0;0;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;34;-272.4599,565.415;Inherit;False;Constant;_Color1;Color 1;2;0;Create;True;0;0;0;False;0;False;0.2515281,0.546,0.3956967,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;36;286.9351,666.5848;Inherit;True;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;33;16.81567,412.0484;Inherit;True;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;10;-704,96;Inherit;True;Color Mask;-1;;1;eec747d987850564c95bde0e5a6d1867;0;4;1;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;5;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;18;-435.5618,90.45638;Inherit;True;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;38;479.1721,415.7603;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;17;-337.8531,-186.4561;Inherit;True;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;31;814.8233,300.5627;Inherit;True;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;16;-97.80045,103.8978;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.TexCoordVertexDataNode;41;-1151.056,804.8789;Inherit;True;0;2;0;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=8CF1CA6C428A64353A5D58B596C17A2E00E2909D