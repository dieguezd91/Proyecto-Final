	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float4 color34 = IsGammaSpace() ? float4(0.2515281,0.546,0.3956967,1) : float4(0.05148999,0.2591152,0.1298723,1);
...
/*ASEBEGIN
Version=18900
0;592;1498;399;1553.365;-470.1833;1.389843;True;False
...
ASEEND*/
//CHKSM=AFF3012B5DFFA2D54D5478FB519A358A3C99C71D